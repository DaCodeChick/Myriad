...
VISION_MODEL="$HOME/Downloads/moondream2-text-model-f16.gguf"
VISION_PROJ="$HOME/Downloads/moondream2-mmproj-f16.gguf"
...
koboldcpp "$TEXT_MODEL" $HW_FLAG --gpulayers $GPU_LAYERS --contextsize 8192 --port $TEXT_PORT > brain_log.txt 2>&1 &
...
koboldcpp "$VISION_MODEL" --mmproj "$VISION_PROJ" $HW_FLAG --gpulayers 15 --contextsize 2048 --port $VISION_PORT > eye_log.txt 2>&1 &
